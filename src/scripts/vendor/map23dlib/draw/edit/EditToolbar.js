...
L.EditToolbar = L.Toolbar.extend({
	options: {
        ...
        favorite: {
            title: L.drawLocal.edit.toolbar.favorite.title
        },
        print:{
            title: L.drawLocal.edit.toolbar.print.title
        },
	...
	addToolbar: function (map) {
        ...
        if(this.options.favorite) {
            this._createButton({
                title: this.options.favorite.title,
                className: buttonClassPrefix + '-favorite',
                container: this._toolbarContainer,
                callback: function(){
                    this._map.fire('favorite');
                },
                context: this
            });
        }
        ...
        if(this.options.print) {
            this._createButton({
                title: this.options.print.title,
                className: buttonClassPrefix + '-print',
                container: this._toolbarContainer,
                callback: function(){
                    this._map.fire('printDraw');
                },
                context: this
            });
        }
