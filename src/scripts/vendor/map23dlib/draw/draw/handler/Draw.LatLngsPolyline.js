L.Draw.LatLngsPolyline = L.Draw.Feature.extend({
    statics: {
        TYPE: 'latlngspolyline'
    },
    ...
    initialize: function (map, options) {
        ...
        this.type = L.Draw.LatLngsPolyline.TYPE;
    ...
    latLngsPicker:function(){
        var _this = this;
        this.pickerContainer = L.DomUtil.create('div','draw-polyline-latlngs-picker');
        ...
        h4.innerHTML = '坐标转线<small>(geojson格式)</small>';
    ...
    _fireCreatedEvent: function () {
        ...
        try
        {
            ...
            if(geometry.length > 2){
                ...
                var poly = new L.Polyline(geometry, this.options.shapeOptions);

                poly.drawType = 'polyline';
